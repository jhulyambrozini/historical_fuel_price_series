...
import type { FuelType, TabId } from './types';

const SUBTITLES: Record<TabId, string> = {
	preco:
		'Monitoramento de preços por posto — menor e maior valor praticado por tipo de combustível.',
	'preco-medio':
		'Preço médio por combustível ao longo do tempo — jan/2026 a jun/2026.',
	'ultimo-preco':
		'Preço médio por posto, últimos valores registrados e histórico de variação de preços.',
	'historico-variacao':
		'Preço médio por posto, últimos valores registrados e histórico de variação de preços.',
	'evolucao-preco-medio':
		'Preço médio por combustível ao longo do tempo — jan/2026 a jun/2026.',
	'evolucao-preco-por-posto':
		'Preço médio de cada posto ao longo do tempo — selecione o combustível.',
};
...
function App() {
	...
	return (
		<div
			...
			{activeTab === 'evolucao-preco-por-posto' && (
				<EvolucaoPrecoPorPostoView />
			)}
			<footer className="grid justify-center gap-2">
				<a
				...
				<small style={{ color: 'var(--color-text-secondary)' }}>
					Dados de consumo de combustíveis • São Mateus/ES
				</small>
			</footer>
		</div>
	);
