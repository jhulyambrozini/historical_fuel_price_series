  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-6 rounded-xl p-4" style={{ backgroundColor: 'var(--color-bg-card)' }}>
        ...
        <div className="flex flex-col gap-0.5">
          <span className="text-xs tracking-wide" style={{ color: 'var(--color-text-muted)' }}>Período</span>
          <span className="text-xl font-semibold" style={{ color: 'var(--color-text-primary)' }}>6 meses</span>
        </div>
        <div className="h-12 w-px" style={{ backgroundColor: 'var(--color-border-light)' }} />
        <div className="flex flex-col gap-0.5">
      ...
      <div className="flex flex-col gap-2 rounded-xl p-4" style={{ backgroundColor: 'var(--color-bg-card)' }}>
        <span className="text-xs tracking-wide" style={{ color: 'var(--color-text-muted)' }}>Exibir combustíveis</span>
        <FuelToggleGroup selectedFuels={selectedFuels} onToggle={onFuelToggle} />
      </div>
      ...
      {selectedFuels.length === 0 ? (
        <div className="flex items-center justify-center rounded-xl p-8" style={{ backgroundColor: 'var(--color-bg-card)', border: '1px solid var(--color-chart-border)', minHeight: 300 }}>
          <span style={{ color: 'var(--color-text-muted)' }}>Selecione ao menos um combustível</span>
        </div>
      ) : (
